      ...
      <div class="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
        ...
        >
          ...
          <div class="prose prose-lg prose-invert text-slate-300 mb-12 leading-relaxed opacity-90">
            ...
            <p class="mb-6">
              My technical versatility spans the full development stack: Python-based ML pipelines with modern frameworks (PyTorch, Scikit-learn, NLP), containerized environments (Docker), full-stack web applications (Vue.js, Flask, PostgreSQL), and interactive business intelligence dashboards (Power BI, Streamlit). Whether architecting knowledge management platforms with bidirectional linking, implementing conversational AI systems, or analyzing food security patterns for policy insights, I approaches every project with analytical rigor honed through <strong class="text-white">7 gold medals in national science competitions</strong>.
            </p>
            <p>
              What drives me isn't just building impressive systems it's ensuring they create measurable impact. Whether developing analytics dashboards that improve production efficiency, segmentation models that guide resource allocation, or natural innovations that offer eco-friendly alternatives, I seeks opportunities where data science intersects with social good. My unique blend of competitive problem-solving excellence, production-grade technical skills, and proven leadership positions me to tackle challenges that require both analytical depth and the ability to execute complex projects from concept to deployment.
            </p>
          </div>
